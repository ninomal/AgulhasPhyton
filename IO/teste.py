...
"""
image_frame = Canvas(root, width=663, height=660)
image_frame.place(x=30, y=33)
...
# ImageView equivalent in Tkinter
#image_frame = tk.Frame(root, width=663, height=660)
#image_frame.place(x=473, y=126)
# You can add an image to this frame using a label or canvas

image_frame = Canvas(root, width=663, height=660)
image_frame.place(x=710, y=360)
logo_img = PhotoImage(file= "IO\image\ess2.png")
image_frame.create_image(100, 100, image = logo_img)
...
anchor_pane = tk.Frame(root, width=251, height=276)
anchor_pane.place(x=55, y=64)

# Labels and other widgets inside the AnchorPane
label_month = tk.Label(anchor_pane, text="Mês:", font=("Helvetica", 21))
label_month.place(x=25, y=14, width=53, height=31)

label_day1 = tk.Label(anchor_pane, text="Dia:", font=("Helvetica", 21))
label_day1.place(x=25, y=45, width=53, height=25)

label_day2 = tk.Label(anchor_pane, text="Dia:", font=("Helvetica", 21))
label_day2.place(x=22, y=141, width=53, height=25)

label_finura = tk.Label(anchor_pane, text="Finura:", font=("Helvetica", 21))
label_finura.place(x=20, y=182, width=90, height=31)

label_agulha = tk.Label(anchor_pane, text="Agulha:", font=("Helvetica", 21))
label_agulha.place(x=19, y=225, width=95, height=31)

#change for radio
combo_setor = ttk.Combobox(anchor_pane, values=["Option 1", "Option 2"], font=("Helvetica", 14))
combo_setor.place(x=21, y=92, width=87, height=25)
combo_setor.set("Setor")

combo_turno = ttk.Combobox(anchor_pane, values=["Option 1", "Option 2"], font=("Helvetica", 14))
...
# DIARIO Label
label_diario = tk.Label(root, text="DIARIO", font=("Helvetica", 25), fg="#273b4d")
label_diario.place(x=22, y=22, width=109, height=42)

# Footer Label
label_footer = tk.Label(root, text="Radical dreamers aw rpg ltda", font=("Helvetica", 17), fg="#1b52a4")
label_footer.place(x=917, y=777, width=349, height=45)

# AnchorPane with Buttons
button_pane = tk.Frame(root, width=334, height=114)
button_pane.place(x=61, y=352)
...
info_pane = tk.Frame(root, width=749, height=138)
info_pane.place(x=395, y=14)

label_agulhas_dia = tk.Label(info_pane, text="Agulhas dia", font=("Helvetica", 18))
label_agulhas_dia.place(x=20, y=14)

button_turno_radio = tk.Button(info_pane, text="Turno radio", font=("Helvetica", 14))
button_turno_radio.place(x=191, y=15)

button_setor_radio = tk.Button(info_pane, text="Setor Radio", font=("Helvetica", 14))
...
# Empty AnchorPanes
empty_pane1 = tk.Frame(root, width=238, height=321)
empty_pane1.place(x=14, y=502)

empty_pane2 = tk.Frame(root, width=227, height=321)
